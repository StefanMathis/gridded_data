...
[`GriddedData::new`]: https://docs.rs/gridded_data/0.1.2/gridded_data/struct.GriddedData.html#method.new
[`GriddedData`]: https://docs.rs/gridded_data/0.1.2/gridded_data/struct.GriddedData.html
[`GriddedData::cell_bounds`]: https://docs.rs/gridded_data/0.1.2/gridded_data/struct.GriddedData.html#method.cell_bounds
...
> Please open an issue on [GitHub](https://github.com/StefanMathis/gridded_data.git).
...
vertices `[2, 0, -1]`; `[2, 0, 3]`; `[2, 1, -1]`; `[2, 1, 3]`; `[5, 0, -1]`; `[5, 0, 3]`; `[5, 1, -1]`; `[5, 1, 3]`.
The method [`GriddedData::cell_bounds`] can be used to find the index pairs of
cells.
